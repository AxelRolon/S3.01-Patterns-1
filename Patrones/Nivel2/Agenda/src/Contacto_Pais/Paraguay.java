...
public class Paraguay implements iPais {

	final private char prefijo = +595;
	final private int maxDigitos = 10;
	...
	public Paraguay(String nombre, String apellido, String numero) {
		this.nombreP = nombre;
	...
	public void setNumero(String numero) {
		if (numero.length() == maxDigitos) {
			...
			System.out.println("Numero incorrecto, ingrese un contacto numerico de 10 digitos");
		}
	}
